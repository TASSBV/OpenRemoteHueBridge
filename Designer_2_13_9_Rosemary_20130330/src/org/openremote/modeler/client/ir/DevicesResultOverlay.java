...
public class DevicesResultOverlay extends JavaScriptObject {

  // Overlay types always have protected, zero-arg ctors
  protected DevicesResultOverlay() { } 
  ...
  public static native DevicesResultOverlay fromJSONString(String jsonString) /*-{
