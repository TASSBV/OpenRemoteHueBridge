...
/**
 * Exception class indicating configuration error in the designer deployment. Often
 * this means an unrecoverable error in configuration which should be sent to admins,
 * addressed and the designer application redeployed.
 *
