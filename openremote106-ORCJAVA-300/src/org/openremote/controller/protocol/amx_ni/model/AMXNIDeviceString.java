...
public class AMXNIDeviceString extends AMXNIDevice {
   ...
   public AMXNIDeviceString(AMXNIGateway gateway, Integer deviceIndex) {
   ...
   public void sendString(String value) {
      this.gateway.sendCommand("SEND_STRING", deviceIndex, value);
   }
   ...
   public void processUpdate(String parameter1, String parameter2) {
      log.info("Will update read string for device (" + deviceIndex + ") with strings " + parameter1 + " , " + parameter2);

      lastReadString = parameter1;
